 ...
 */
public class LoginActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<JSONArray>{
...
//            mAuthTask.execute((Void) null);
    ...
    public Loader<JSONArray> onCreateLoader(int id, Bundle args) {
        ...
        String urlText = "http://line-app-83253.herokuapp.com/users?email=" + mEmail;
